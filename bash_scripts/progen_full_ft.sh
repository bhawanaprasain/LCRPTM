...
mkdir -p training_logs/full_finetuned_progen_${progen_model_size}/${ptm_alias}

nohup python3 -u src/progen/full_ft.py > training_logs/full_finetuned_progen_${progen_model_size}/${ptm_alias}/motif_marker_${motif_mode}_window_${window_size}_num_of_epochs_${num_of_epochs}.log 2>&1 &
