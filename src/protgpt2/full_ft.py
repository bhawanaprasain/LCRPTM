...
train_df = train_df[:129000]
print(train_df["Label"].value_counts(), "Reduced train df val counts")
...
output_dir = f"training_output/full_finetuned_protgpt2/{ptm}/motif_marker_{motif_mode}_window_{max_seq_len}_num_of_epochs_{num_of_epochs}"
